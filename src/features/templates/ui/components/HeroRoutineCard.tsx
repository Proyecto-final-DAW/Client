...
export const HeroRoutineCard = (props: Props): React.JSX.Element => {
  ...
  return (
    <article className="relative border-2 border-green-500/60 bg-card p-6 sm:p-8 shadow-[0_0_0_4px_rgba(10,10,15,0.6),0_0_60px_rgba(34,197,94,0.18)]">
      ...
      <h2 className="mt-3 font-pixel text-sm sm:text-base leading-relaxed text-green-400 [text-shadow:0_0_14px_rgba(34,197,94,0.55)] break-words">
      ...
      <div className="mt-5 flex flex-wrap items-center gap-3">
        <span className="font-pixel text-[10px] tracking-widest border-2 border-green-500/40 bg-green-500/10 text-green-400 px-2 py-1">
