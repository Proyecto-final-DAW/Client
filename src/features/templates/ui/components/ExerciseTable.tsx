      ...
      <table className="w-full text-left">
        ...
        <tbody>
          {props.exercises.map((exercise, index) => (
            ...
            >
              <td className="font-['Press_Start_2P'] text-base text-[#71717a] px-3 py-3">
                {index + 1}
              </td>
              <td className="font-['Press_Start_2P'] text-lg text-[#e4e4e7] px-3 py-3">
                {exercise.name}
              </td>
              <td className="font-['Press_Start_2P'] text-base text-[#a1a1aa] px-3 py-3 hidden sm:table-cell">
                {exercise.muscleGroup}
              </td>
              <td className="font-['Press_Start_2P'] text-lg text-green-400 px-3 py-3 text-center whitespace-nowrap">
                {exercise.sets} × {exercise.reps}
              </td>
              <td className="font-['Press_Start_2P'] text-base text-[#a1a1aa] px-3 py-3 text-center whitespace-nowrap">
