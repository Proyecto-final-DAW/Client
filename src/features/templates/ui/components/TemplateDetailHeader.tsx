...
export const TemplateDetailHeader = (props: Props): React.JSX.Element => {
  ...
  return (
    <header className="relative border-2 border-green-500/40 bg-card p-5 mb-6">
      <PixelCorners size="md" className="border-green-500/60" />

      <h1 className="font-pixel text-sm sm:text-base leading-relaxed text-green-400 [text-shadow:0_0_16px_rgba(34,197,94,0.55)]">
        {template.name}
      </h1>
