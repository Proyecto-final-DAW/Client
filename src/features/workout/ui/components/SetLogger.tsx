...
export const SetLogger = (props: Props): React.JSX.Element => {
  ...
  return (
    <div className="flex flex-col gap-5 border-2 border-[#1e1e2e] bg-[#0d0d14] p-5">
      <div className="grid grid-cols-2 gap-4">
        <div className="flex flex-col items-center gap-2">
          <label
            htmlFor="set-weight"
            className="font-['Press_Start_2P'] text-[8px] tracking-widest text-[#a1a1aa]"
          >
            PESO (KG)
          </label>
          <div className="flex items-center gap-2">
            <button
              ...
              className="font-['Press_Start_2P'] text-sm w-10 h-10 border-2 border-[#1e1e2e] bg-[#18181b] text-[#a1a1aa] hover:border-green-500/40 hover:text-green-400 transition-colors"
            >
              −
            </button>
            <input
              ...
              className="font-['Press_Start_2P'] text-base w-24 h-12 text-center bg-[#18181b] border-2 border-[#1e1e2e] text-green-400 outline-none focus:border-green-500/60"
            />
            <button
              type="button"
              onClick={() => adjustWeight(WEIGHT_STEP)}
