...
const MAESTRO_PIXELS: ReadonlyArray<readonly [number, number]> = [
  ...
  [7, 5], [8, 5],
  [7, 6], [8, 6],
  [5, 8], [6, 8], [7, 8], [8, 8], [9, 8], [10, 8], // shoulder line / arms
  [6, 9], [7, 9], [8, 9], [9, 9],
  [6, 10], [7, 10], [8, 10], [9, 10],
  [5, 11], [6, 11], [7, 11], [8, 11], [9, 11], [10, 11], // base / lotus seat
];
...
const PIXEL_MAP: Record<Props['classId'], ReadonlyArray<readonly [number, number]>> = {
  MAESTRO_SUPREMO: MAESTRO_PIXELS,
  LEYENDA: LEYENDA_PIXELS,
};

export const ClassPixelArt = ({ classId, color, className, style }: Props): React.JSX.Element => {
