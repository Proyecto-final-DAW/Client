    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0 flex-1">
          <div
            className={`font-pixel text-[9px] sm:text-[10px] tracking-wider ${props.isSelected ? 'text-green-400' : 'text-ink'}`}
          >
            {props.option.title}
          </div>
          <div className="font-pixel-mono text-base sm:text-lg text-ink-muted mt-1 leading-tight">
