...
export const Login = (): React.JSX.Element => {
  ...
  return (
    <div className="relative min-h-screen bg-[#0a0a0f] text-[#e4e4e7] overflow-hidden">
      ...
      <main className="relative z-10 flex items-center justify-center px-4 sm:px-6 py-12 sm:py-16 min-h-[calc(100vh-6rem)]">
        <div className="w-full max-w-md">
          ...
          <form
            ...
            className="relative border-2 border-green-500/60 bg-[#0d0d14] p-6 sm:p-8 shadow-[0_0_0_4px_rgba(10,10,15,0.8),0_0_60px_rgba(34,197,94,0.35),0_20px_50px_rgba(0,0,0,0.8)]"
          >
            ...
            <div className="text-[9px] sm:text-[10px] font-['Press_Start_2P'] text-green-500 mb-6 tracking-wider">
              ─ LOGIN ─
            </div>
            ...
            {error && (
              <p
                role="alert"
                className="font-['Press_Start_2P'] text-[8px] sm:text-[10px] text-red-400 mb-4 leading-loose tracking-wide border-2 border-red-500/40 bg-red-500/10 px-3 py-2"
              >
                ✕ {error}
              </p>
            )}
