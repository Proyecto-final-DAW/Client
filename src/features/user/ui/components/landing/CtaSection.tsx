  ...
  return (
    <section className="py-16 sm:py-24">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
        <div className="border-2 border-border bg-subtle/85 backdrop-blur-md p-8 sm:p-12 relative">
          ...
          <Link
            to="/register"
            className="inline-block font-pixel text-[10px] sm:text-xs bg-green-500 hover:bg-green-400 text-[#0a0a0f] px-8 sm:px-10 py-3.5 sm:py-4 border-b-4 border-green-700 hover:border-green-600 active:border-b-0 active:mt-1 transition-all duration-150 shadow-[0_0_16px_rgba(34,197,94,0.35)]"
          >
            ▶ EMPEZAR AVENTURA
          </Link>
        </div>
